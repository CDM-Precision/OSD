...
.NOTES
    Version 22.9.13.1
.LINK
    https://raw.githubusercontent.com/CDM-Precision/OSD/main/cloud/modules/eq-winpe-startup.psm1
.EXAMPLE
...
function osdcloud-StartWinPE {
    ...
    if ($env:SystemDrive -eq 'X:') {
        ...
        if ($OSDCloud) {
            ...
            #osdcloud-InstallCDMModule -Name DownloadFile -URL "https://github.com/CDM-Precision/CDM-DownloadFile/archive/refs/heads/main.zip" #df url
