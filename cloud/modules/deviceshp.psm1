...
.LINK
    https://raw.githubusercontent.com/CDM-Precision/OSD/master/cloud/modules/deviceshp.psm1
.EXAMPLE
...
function osdcloud-HPSetupCompleteAppend {
    ...
    if (Test-Path -Path $PSFilePath){
        ...
        Add-Content -Path $PSFilePath "Invoke-Expression (Invoke-RestMethod -Uri 'https://raw.githubusercontent.com/CDM-Precision/OSD/master/cloud/modules/eq-winpe.psm1')"
        Add-Content -Path $PSFilePath "Invoke-Expression (Invoke-RestMethod -Uri 'https://raw.githubusercontent.com/CDM-Precision/OSD/refs/heads/master/cloud/functions.ps1' -ErrorAction SilentlyContinue)"
